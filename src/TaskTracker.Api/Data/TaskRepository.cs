...
public sealed class TaskRepository
{
    ...
    public TaskItem Add(string title, string description, string priority)
    {
    ...
    public TaskItem? Update(Guid id, string title, string description, string priority, bool isDone)
    {
        var task = GetById(id);
